...
from users.forms import (AddressDetailsUserForm, AddressForm,
                         BasicInfoUserForm, EducationFormSet,
                         EducationInfoForm, ExperienceForm, LoginForm,
                         ProfileForm, RegisterForm, SocialFormSet,
                         SocialMediaForm, TrainingForm)
